...
class Transform(tf.Module):
    ...
    def _get_trainable_variables(self, **var_kwargs):
        pass

    def get_trainable_variables(self, **var_kwargs):
        return self._get_trainable_variables(**var_kwargs)

    def test(self, shape, **kwargs):
        """
        Tests shape and ldj of forward and inverse transform 
        """
        return self._test(shape, **kwargs)
