...
class CondSplit(Transform):
    """
    Implementation of the 'conditional split' transform, which factors out half of the channel dimensions
    ...
    def _test(self, shape, **kwargs):
        ...
        x_, ildj = self._inverse(y1, z2, y_cond=y_cond, **kwargs)
