...
def write_jobscript():
    ...
    f.write("{}/prepareSimulation.sh {} {} {} {} {}\n\n".format(
                script_path, base_path, run_dir_HR, config['level_HR'], tend, dt))

    f.write("{}/prepareSimulation.sh {} {} {} {} {}\n\n".format(
                script_path, base_path, run_dir_LR, config['level_LR'], tend, dt))
    ...
    f.write("cd {}\n".format(script_path))
    f.write("./runDataBuilder.py --config_file {} --sim_id {}\n".format(args.config_file, args.sim_id+1))
    f.close()
